...
public class SuitPowerSupplyItem extends Item implements IIronmanKeybindCapableItem {
        ...
        return new ICapabilityProvider() {
            ...
            public <T> LazyOptional<T> getCapability(@Nonnull Capability<T> cap, @Nullable Direction side) {
                if (cap == ForgeCapabilities.ENERGY)
                    return LazyOptional.of(() -> new ItemEnergyStorageImpl(stack, energyStorage, energyTransfer)).cast();
