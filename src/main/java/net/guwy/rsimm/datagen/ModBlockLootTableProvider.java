...
import net.guwy.rsimm.datagen.loot_tables.OreBlockLootTableRegistry;
import net.guwy.rsimm.datagen.loot_tables.SimpleBlockLootTableRegistry;
...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        SimpleBlockLootTableRegistry.itemDroppingBlockMap.forEach((minedBlock, item) ->
                add(minedBlock, block ->
                        createItemFromBlockDrop(minedBlock, item))
        );
    ...
    protected Iterable<Block> getKnownBlocks() {
        ...
        // Basic Registry
        //list.addAll(List.of(IMBlocksNItems.BLACK_SAND.get(), IMBlocksNItems.BLACK_SAND_DIAMOND_ORE.get(), IMBlocksNItems.BLACK_SAND_GOLD_ORE.get(), IMBlocksNItems.BLACK_SAND_PLATINUM_ORE.get()));
