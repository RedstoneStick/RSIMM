...
public class IngotTagsDatagen {
    private static void init() {
        register("palladium", IMBlocksNItems.PALLADIUM_INGOT.get());
        register("magnesium", IMBlocksNItems.MAGNESIUM_INGOT.get());
        register("platinum", IMBlocksNItems.PLATINUM_INGOT.get());
    }
