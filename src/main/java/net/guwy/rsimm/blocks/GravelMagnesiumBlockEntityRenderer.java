...
public class GravelMagnesiumBlockEntityRenderer implements BlockEntityRenderer<GravelMagnesiumBlockEntity> {
    private final ItemRenderer itemRenderer;

    public GravelMagnesiumBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
        this.itemRenderer = context.getItemRenderer();
    }

    public void render(GravelMagnesiumBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
    ...
    public AABB getRenderBoundingBox(GravelMagnesiumBlockEntity blockEntity) {
